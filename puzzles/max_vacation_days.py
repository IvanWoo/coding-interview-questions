# https://techdevguide.withgoogle.com/paths/advanced/working-in-multiple-languages-maximum-vacation-days/#!
"""
...
def helper(
    ...
    plans = []
    for k, v in enumerate(flights[city]):
        if v == 1:
...
def max_vacation_days(flights: List[List[int]], days: List[List[int]]) -> int:
    return helper(flights, days, 0, 0, 0)


# http://bookshadow.com/weblog/2017/04/30/leetcode-maximum-vacation-days/
def max_vacation_days_dp(flights: List[List[int]], days: List[List[int]]) -> int:
